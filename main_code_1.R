...
data <- fread("/home/gc/FCD/BigDataRAzure/Project-2/Dataset/train.csv")
test <- fread("/home/gc/FCD/BigDataRAzure/Project-2/Dataset/test.csv")
...
fwrite(data,"/home/gc/FCD/BigDataRAzure/Project-2/Dataset/train_2.csv")
fwrite(test,"/home/gc/FCD/BigDataRAzure/Project-2/Dataset/test_2.csv")
